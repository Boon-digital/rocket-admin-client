...
var Primitive$i = NODES$i.reduce((primitive, node) => {
...
var Primitive$h = NODES$h.reduce((primitive, node) => {
  const Slot = createSlot(`Primitive.${node}`);
  const Node = reactExports.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot : node;
...
var Primitive$g = NODES$g.reduce((primitive, node) => {
  const Slot = createSlot(`Primitive.${node}`);
  const Node = reactExports.forwardRef((props, forwardedRef) => {
    const { asChild, ...primitiveProps } = props;
    const Comp = asChild ? Slot : node;
...
export {
  ...
  Primitive$g as b,
  Primitive$f as c,
  dispatchDiscreteCustomEvent$1 as d,
  Primitive$e as e,
  Primitive$d as f,
  Primitive$c as g,
  Primitive$b as h,
