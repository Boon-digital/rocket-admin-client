import { i as isUrl } from "../../../_libs/is-url.mjs";
import { a as $d636bc798e7178db$export$185802fd694ee1f5, b as $b422b1e013cd6010$export$3ce6949f20cea765 } from "../../../_libs/fontkit.mjs";
import { P as PDFFont } from "./pdfkit.mjs";
...
class FontSource {
  ...
  async _load() {
    ...
    if (STANDARD_FONTS.includes(this.src)) {
      ...
      data = $d636bc798e7178db$export$185802fd694ee1f5(uint8Array, postscriptName);
    } else if (isUrl(this.src)) {
      const { headers, body, method = "GET" } = this.options;
      const buffer = await fetchFont(this.src, { method, body, headers });
      data = $d636bc798e7178db$export$185802fd694ee1f5(buffer, postscriptName);
    } else {
      data = await $b422b1e013cd6010$export$3ce6949f20cea765(this.src, postscriptName);
    }
