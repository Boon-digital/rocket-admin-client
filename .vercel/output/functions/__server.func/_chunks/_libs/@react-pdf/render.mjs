import { P as Page, T as Text, S as Svg, L as Link, C as Canvas, a as List, b as Checkbox, c as Select, d as TextInput, F as FieldSet, I as Image, N as Note, e as Polyline, f as Polygon, E as Ellipse, g as Circle, G, h as Line, R as Rect, i as Path, j as TextInstance, k as Tspan, l as LinearGradient, m as RadialGradient } from "./primitives.mjs";
import { i as isNil, m as matchPercent } from "./fns.mjs";
import { a as absPath } from "../../../_libs/abs-svg-path.mjs";
import { p as parsePath } from "../../../_libs/parse-svg-path.mjs";
import { n as normalize } from "../../../_libs/normalize-svg-path.mjs";
...
const applyContainObjectFit = (cw, ch, iw, ih, px, py) => {
  ...
  if (cr > ir) {
    ...
    return { width: width2, height: height2, xOffset: xOffset2, yOffset: yOffset2 };
  }
  const width = cw;
...
const applyCoverObjectFit = (cw, ch, iw, ih, px, py) => {
  ...
  if (cr > ir) {
    ...
    return { width: width2, height: height2, yOffset: yOffset2, xOffset: xOffset2 };
  }
  const height = ch;
